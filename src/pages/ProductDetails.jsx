            ...
            <section className='py-10 md:py-20'>
                <Container>
                    <div className="max-w-120 shadow shadow-green-800 p-10 rounded-md mx-auto bg-gray-100">
                        ...
                        <button onClick={handleAddCart} className='cursor-pointer bg-green-950 py-2.5 text-gray-100 text-base font-medium block w-full rounded-md mt-4 border-2 border-green-950 duration-300 hover:bg-gray-100 hover:text-green-950 hover:font-semibold'>Add To Cart</button>
                    </div>
                </Container>
            </section>
        </>
